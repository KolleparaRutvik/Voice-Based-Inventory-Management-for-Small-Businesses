        ...
        additional_shops = [
            ...
            },
            {
                ...
                'products': [
                    ...
                    {'id': 'pbbbbbb-0000-0000-0000-000000000007', 'name': 'Rolon Chain Sprocket Kit (చైన్ కిట్)', 'local_name': 'Chain Sprocket', 'category': 'Brake & Clutch Parts', 'base_unit': 'set', 'purchase_unit': 'set', 'selling_unit': 'set', 'conversion_factor': 1.0, 'purchase_price': 850.0, 'selling_price': 1150.0, 'minimum_stock': 3.0, 'recommended_stock': 15.0, 'reorder_quantity': 5.0, 'current_stock': 9.0},
                ]
            },
            {
            ...
            },
            {
                ...
                'products': [
                    ...
                    {'id': 'pdddddd-0000-0000-0000-000000000007', 'name': 'Noise ColorFit Pulse Smart Watch (స్మార్ట్ వాచ్)', 'local_name': 'Smart Watch', 'category': 'Smartphones', 'base_unit': 'piece', 'purchase_unit': 'box', 'selling_unit': 'piece', 'conversion_factor': 5.0, 'purchase_price': 6500.0, 'selling_price': 1799.0, 'minimum_stock': 3.0, 'recommended_stock': 15.0, 'reorder_quantity': 5.0, 'current_stock': 8.0},
                ]
            }
        ]
