...
class LocalDbClient:
    ...
    def _init_seed_data(self):
        ...
        jewel_catalog = [
            ...
            {'id': 'p2222222-0000-0000-0000-000000000007', 'name': '18K Diamond Solitaire Ring (వజ్రపు ఉంగరం)', 'local_name': 'Vajram Ring', 'category': 'Diamond & Gemstone Jewellery', 'base_unit': 'piece', 'purchase_unit': 'piece', 'selling_unit': 'piece', 'conversion_factor': 1.0, 'purchase_price': 35000.0, 'selling_price': 42000.0, 'minimum_stock': 1.0, 'recommended_stock': 6.0, 'reorder_quantity': 2.0, 'current_stock': 4.0}
        ]
        ...
        flower_catalog = [
            ...
            {'id': 'p3333333-0000-0000-0000-000000000007', 'name': 'Pooja Camphor / Karpuram (కర్పూరం)', 'local_name': 'Karpuram', 'category': 'Pooja & Temple Offerings', 'base_unit': 'packet', 'purchase_unit': 'box', 'selling_unit': 'packet', 'conversion_factor': 20.0, 'purchase_price': 500.0, 'selling_price': 35.0, 'minimum_stock': 15.0, 'recommended_stock': 60.0, 'reorder_quantity': 30.0, 'current_stock': 45.0}
        ]
        ...
        additional_shops = [
            {
                ...
                'products': [
                    ...
                    {'id': 'p4444444-0000-0000-0000-000000000007', 'name': 'Handloom Cotton Saree (చేనేత చీర)', 'local_name': 'Handloom Saree', 'category': "Women's Sarees & Dresses", 'base_unit': 'piece', 'purchase_unit': 'piece', 'selling_unit': 'piece', 'conversion_factor': 1.0, 'purchase_price': 950.0, 'selling_price': 1450.0, 'minimum_stock': 8.0, 'recommended_stock': 35.0, 'reorder_quantity': 15.0, 'current_stock': 24.0},
                ]
            },
            {
                ...
                'products': [
                    ...
                    {'id': 'p5555555-0000-0000-0000-000000000007', 'name': 'Azithromycin 500mg Tablets (Azee 500)', 'local_name': 'Azee 500', 'category': 'Tablets & Capsules', 'base_unit': 'strip', 'purchase_unit': 'box', 'selling_unit': 'strip', 'conversion_factor': 10.0, 'purchase_price': 780.0, 'selling_price': 115.0, 'minimum_stock': 10.0, 'recommended_stock': 40.0, 'reorder_quantity': 20.0, 'current_stock': 28.0},
                ]
            },
            {
                ...
                'products': [
                    ...
                    {'id': 'p6666666-0000-0000-0000-000000000007', 'name': 'Vanilla Fresh Cream Roll (క్రీమ్ రోల్)', 'local_name': 'Cream Roll', 'category': 'Daily Breads & Buns', 'base_unit': 'piece', 'purchase_unit': 'tray', 'selling_unit': 'piece', 'conversion_factor': 20.0, 'purchase_price': 200.0, 'selling_price': 18.0, 'minimum_stock': 15.0, 'recommended_stock': 60.0, 'reorder_quantity': 30.0, 'current_stock': 40.0},
                ]
            },
            {
                ...
                'products': [
                    ...
                    {'id': 'p7777777-0000-0000-0000-000000000007', 'name': 'Chapathi with Mixed Veg Kurma (చపాతీ)', 'local_name': 'Chapathi', 'category': 'Breakfast Tiffins', 'base_unit': 'plate', 'purchase_unit': 'plate', 'selling_unit': 'plate', 'conversion_factor': 1.0, 'purchase_price': 22.0, 'selling_price': 50.0, 'minimum_stock': 15.0, 'recommended_stock': 80.0, 'reorder_quantity': 30.0, 'current_stock': 55.0},
                ]
            },
            {
                ...
                'products': [
                    ...
                    {'id': 'p8888888-0000-0000-0000-000000000007', 'name': 'Bun Maska (బన్ మస్కా)', 'local_name': 'Bun Maska', 'category': 'Tea Stall Snacks', 'base_unit': 'piece', 'purchase_unit': 'piece', 'selling_unit': 'piece', 'conversion_factor': 1.0, 'purchase_price': 12.0, 'selling_price': 25.0, 'minimum_stock': 15.0, 'recommended_stock': 70.0, 'reorder_quantity': 25.0, 'current_stock': 45.0},
                ]
            },
            {
                ...
                'products': [
                    ...
                    {'id': 'paaaaaa-0000-0000-0000-000000000007', 'name': '9W LED Bulbs Cool White (ఎల్ఈడీ బల్బు)', 'local_name': 'LED Bulbs', 'category': 'Electrical Wires & Switches', 'base_unit': 'piece', 'purchase_unit': 'box', 'selling_unit': 'piece', 'conversion_factor': 20.0, 'purchase_price': 1100.0, 'selling_price': 85.0, 'minimum_stock': 15.0, 'recommended_stock': 60.0, 'reorder_quantity': 25.0, 'current_stock': 40.0},
                ]
            },
            {
                ...
                'suppliers': [
                    ...
                    {'name': 'TVS & Bosch Auto Distributors', 'phone': '+91 98480bb003', 'email': 'bosch@autowholesale.in', 'address': 'Ranigunj, Secunderabad'},
                    {'name': 'Exide & Amaron Power Hub', 'phone': '+91 98480bb004', 'email': 'batteries@powerhub.com', 'address': 'Kukatpally, Hyderabad'}
                ],
                'customers': [
                    {'name': 'Shiva Mechanic (Shiva Auto Garage Tab)', 'phone': '+91 98480bb111', 'credit': 12500.0, 'notes': 'Engine oil cartons & brake parts'},
                    {'name': 'Ramesh Auto Garage (Running Spares Credit)', 'phone': '+91 98480bb222', 'credit': 7800.0, 'notes': 'Tyres and battery replacement balance'},
                    {'name': 'Raju Bike Point (Engine Oil & Pads Tab)', 'phone': '+91 98480bb333', 'credit': 3450.0, 'notes': 'Weekly servicing oil & spark plugs tab'}
                ],
                'products': [
                    ...
                    {'id': 'pbbbbbb-0000-0000-0000-000000000002', 'name': 'Motul 3000 4T Plus 10W-30 1L (మోటుల్ ఇంజన్ ఆయిల్)', 'local_name': 'Motul Oil', 'category': 'Engine Oils & Lubricants', 'base_unit': 'bottle', 'purchase_unit': 'box', 'selling_unit': 'bottle', 'conversion_factor': 12.0, 'purchase_price': 4440.0, 'selling_price': 440.0, 'minimum_stock': 10.0, 'recommended_stock': 50.0, 'reorder_quantity': 20.0, 'current_stock': 28.0},
                    {'id': 'pbbbbbb-0000-0000-0000-000000000003', 'name': 'Hero Splendor Brake Shoes (బ్రేక్ షూస్)', 'local_name': 'Brake Shoes', 'category': 'Brake Systems & Pads', 'base_unit': 'set', 'purchase_unit': 'box', 'selling_unit': 'set', 'conversion_factor': 10.0, 'purchase_price': 1800.0, 'selling_price': 240.0, 'minimum_stock': 8.0, 'recommended_stock': 50.0, 'reorder_quantity': 20.0, 'current_stock': 30.0},
                    {'id': 'pbbbbbb-0000-0000-0000-000000000004', 'name': 'Front Disc Brake Pads Pulsar / Apache (ఫ్రంట్ డిస్క్ ప్యాడ్లు)', 'local_name': 'Disc Brake Pads', 'category': 'Brake Systems & Pads', 'base_unit': 'set', 'purchase_unit': 'box', 'selling_unit': 'set', 'conversion_factor': 10.0, 'purchase_price': 2600.0, 'selling_price': 350.0, 'minimum_stock': 6.0, 'recommended_stock': 30.0, 'reorder_quantity': 12.0, 'current_stock': 15.0},
                    {'id': 'pbbbbbb-0000-0000-0000-000000000005', 'name': 'Amaron 12V Bike Battery 4Ah (బైక్ బ్యాటరీ)', 'local_name': 'Bike Battery', 'category': 'Batteries & Horns', 'base_unit': 'unit', 'purchase_unit': 'unit', 'selling_unit': 'unit', 'conversion_factor': 1.0, 'purchase_price': 1180.0, 'selling_price': 1450.0, 'minimum_stock': 3.0, 'recommended_stock': 20.0, 'reorder_quantity': 6.0, 'current_stock': 12.0},
                    {'id': 'pbbbbbb-0000-0000-0000-000000000006', 'name': 'MRF Nylogrip Tyre 90/90-12 Activa (ఎంఆర్ఎఫ్ టైరు)', 'local_name': 'MRF Tyre', 'category': 'Tyres & Tubes', 'base_unit': 'piece', 'purchase_unit': 'piece', 'selling_unit': 'piece', 'conversion_factor': 1.0, 'purchase_price': 1380.0, 'selling_price': 1650.0, 'minimum_stock': 4.0, 'recommended_stock': 25.0, 'reorder_quantity': 8.0, 'current_stock': 16.0},
                    {'id': 'pbbbbbb-0000-0000-0000-000000000007', 'name': 'Spark Plug NGK 2-Wheeler (స్పార్క్ ప్లగ్)', 'local_name': 'Spark Plug', 'category': 'Ignition & Electricals', 'base_unit': 'piece', 'purchase_unit': 'box', 'selling_unit': 'piece', 'conversion_factor': 10.0, 'purchase_price': 650.0, 'selling_price': 95.0, 'minimum_stock': 15.0, 'recommended_stock': 100.0, 'reorder_quantity': 30.0, 'current_stock': 60.0},
                    {'id': 'pbbbbbb-0000-0000-0000-000000000008', 'name': 'Rolon Chain Sprocket Kit Splendor (చైన్ కిట్)', 'local_name': 'Chain Sprocket', 'category': 'Transmission & Chains', 'base_unit': 'set', 'purchase_unit': 'set', 'selling_unit': 'set', 'conversion_factor': 1.0, 'purchase_price': 850.0, 'selling_price': 1150.0, 'minimum_stock': 3.0, 'recommended_stock': 15.0, 'reorder_quantity': 5.0, 'current_stock': 9.0},
                    {'id': 'pbbbbbb-0000-0000-0000-000000000009', 'name': 'Clutch Cable for Bajaj Pulsar (క్లచ్ కేబుల్)', 'local_name': 'Clutch Cable', 'category': 'Cables & Filters', 'base_unit': 'piece', 'purchase_unit': 'bundle', 'selling_unit': 'piece', 'conversion_factor': 10.0, 'purchase_price': 850.0, 'selling_price': 130.0, 'minimum_stock': 6.0, 'recommended_stock': 40.0, 'reorder_quantity': 15.0, 'current_stock': 25.0},
                    {'id': 'pbbbbbb-0000-0000-0000-000000000010', 'name': 'Roots 12V High-Tone Bike Horn (రూట్స్ బైక్ హారన్)', 'local_name': 'Bike Horn', 'category': 'Batteries & Horns', 'base_unit': 'piece', 'purchase_unit': 'box', 'selling_unit': 'piece', 'conversion_factor': 6.0, 'purchase_price': 1500.0, 'selling_price': 320.0, 'minimum_stock': 4.0, 'recommended_stock': 24.0, 'reorder_quantity': 8.0, 'current_stock': 14.0},
                    {'id': 'pbbbbbb-0000-0000-0000-000000000011', 'name': 'Air Filter for Hero Splendor / HF (ఎయిర్ ఫిల్టర్)', 'local_name': 'Air Filter', 'category': 'Cables & Filters', 'base_unit': 'piece', 'purchase_unit': 'box', 'selling_unit': 'piece', 'conversion_factor': 10.0, 'purchase_price': 950.0, 'selling_price': 140.0, 'minimum_stock': 8.0, 'recommended_stock': 40.0, 'reorder_quantity': 15.0, 'current_stock': 22.0},
                    {'id': 'pbbbbbb-0000-0000-0000-000000000012', 'name': 'WD-40 / Motul Chain Lube Spray 400ml (చైన్ ల్యూబ్ స్ప్రే)', 'local_name': 'Chain Lube', 'category': 'Care & Maintenance', 'base_unit': 'can', 'purchase_unit': 'box', 'selling_unit': 'can', 'conversion_factor': 12.0, 'purchase_price': 3240.0, 'selling_price': 350.0, 'minimum_stock': 6.0, 'recommended_stock': 30.0, 'reorder_quantity': 12.0, 'current_stock': 18.0},
                ]
            },
            {
                ...
                'products': [
                    ...
                    {'id': 'pcccccc-0000-0000-0000-000000000007', 'name': 'Kashmir Red Apples (కాశ్మీర్ యాపిల్స్)', 'local_name': 'Apples', 'category': 'Fresh Fruits', 'base_unit': 'kg', 'purchase_unit': 'box', 'selling_unit': 'kg', 'conversion_factor': 18.0, 'purchase_price': 2160.0, 'selling_price': 160.0, 'minimum_stock': 15.0, 'recommended_stock': 60.0, 'reorder_quantity': 30.0, 'current_stock': 35.0},
                ]
            },
            {
                ...
                'suppliers': [
                    {'name': 'Redmi & Xiaomi National Distributor', 'phone': '+91 9876554001', 'email': 'xiaomidist@mobilehub.com', 'address': 'Electronics Plaza, Hyderabad'},
                    {'name': 'boAt Audio Official Distributorship', 'phone': '+91 98480dd002', 'email': 'boatdist@audio.in', 'address': 'Warangal'},
                    {'name': 'Samsung Mobile Regional Wholesale', 'phone': '+91 98480dd001', 'email': 'samsung@wholesalehub.com', 'address': 'Secunderabad'},
                    {'name': 'SanDisk & Portronics Gadgets Agency', 'phone': '+91 98480dd003', 'email': 'orders@gadgetagency.in', 'address': 'Koti, Hyderabad'}
                ],
                'customers': [
                    {'name': 'Kalyan (Engineering Student Tab)', 'phone': '+91 98480dd111', 'credit': 1500.0, 'notes': 'Fast charger and earbuds balance'},
                    {'name': 'Naresh (Samsung Phone EMI Account)', 'phone': '+91 98480dd222', 'credit': 9500.0, 'notes': 'Samsung Galaxy balance installment'},
                    {'name': 'Suresh (Display & Tempered Glass Udhar)', 'phone': '+91 98480dd333', 'credit': 2800.0, 'notes': 'Screen replacement & 11D tempered glass'}
                ],
                'products': [
                    ...
                    {'id': 'pdddddd-0000-0000-0000-000000000002', 'name': 'Redmi 13C 5G 128GB (రెడ్‌మి 5G మొబైల్)', 'local_name': 'Redmi Mobile', 'category': 'Smartphones', 'base_unit': 'unit', 'purchase_unit': 'unit', 'selling_unit': 'unit', 'conversion_factor': 1.0, 'purchase_price': 9800.0, 'selling_price': 11499.0, 'minimum_stock': 2.0, 'recommended_stock': 15.0, 'reorder_quantity': 5.0, 'current_stock': 9.0},
                    {'id': 'pdddddd-0000-0000-0000-000000000003', 'name': 'boAt Airdopes 141 Bluetooth Earbuds (ఇయర్ బడ్స్)', 'local_name': 'boAt Earbuds', 'category': 'Bluetooth Audio & Sound', 'base_unit': 'unit', 'purchase_unit': 'box', 'selling_unit': 'unit', 'conversion_factor': 10.0, 'purchase_price': 8900.0, 'selling_price': 1199.0, 'minimum_stock': 5.0, 'recommended_stock': 35.0, 'reorder_quantity': 10.0, 'current_stock': 22.0},
                    {'id': 'pdddddd-0000-0000-0000-000000000004', 'name': 'boAt Rockerz 255 Pro+ Neckband (బ్లూటూత్ నెక్‌బ్యాండ్)', 'local_name': 'boAt Neckband', 'category': 'Bluetooth Audio & Sound', 'base_unit': 'unit', 'purchase_unit': 'box', 'selling_unit': 'unit', 'conversion_factor': 10.0, 'purchase_price': 7800.0, 'selling_price': 1099.0, 'minimum_stock': 4.0, 'recommended_stock': 25.0, 'reorder_quantity': 8.0, 'current_stock': 16.0},
                    {'id': 'pdddddd-0000-0000-0000-000000000005', 'name': 'Fast 20W Type-C Charger Adapter (టైప్-సి ఛార్జర్)', 'local_name': 'Fast Charger', 'category': 'Fast Chargers & Adapters', 'base_unit': 'unit', 'purchase_unit': 'box', 'selling_unit': 'unit', 'conversion_factor': 10.0, 'purchase_price': 3200.0, 'selling_price': 499.0, 'minimum_stock': 10.0, 'recommended_stock': 60.0, 'reorder_quantity': 20.0, 'current_stock': 40.0},
                    {'id': 'pdddddd-0000-0000-0000-000000000006', 'name': 'SuperVOOC 33W Fast Charger with Cable (33W ఫాస్ట్ ఛార్జర్)', 'local_name': '33W Charger', 'category': 'Fast Chargers & Adapters', 'base_unit': 'unit', 'purchase_unit': 'box', 'selling_unit': 'unit', 'conversion_factor': 10.0, 'purchase_price': 5200.0, 'selling_price': 799.0, 'minimum_stock': 5.0, 'recommended_stock': 30.0, 'reorder_quantity': 10.0, 'current_stock': 18.0},
                    {'id': 'pdddddd-0000-0000-0000-000000000007', 'name': '10000mAh Dual USB Power Bank (పవర్ బ్యాంక్)', 'local_name': 'Power Bank', 'category': 'Powerbanks & Cables', 'base_unit': 'unit', 'purchase_unit': 'box', 'selling_unit': 'unit', 'conversion_factor': 5.0, 'purchase_price': 3800.0, 'selling_price': 999.0, 'minimum_stock': 3.0, 'recommended_stock': 25.0, 'reorder_quantity': 10.0, 'current_stock': 15.0},
                    {'id': 'pdddddd-0000-0000-0000-000000000008', 'name': '20000mAh 22.5W Fast Power Bank (20000mAh పవర్ బ్యాంక్)', 'local_name': '20000mAh Power Bank', 'category': 'Powerbanks & Cables', 'base_unit': 'unit', 'purchase_unit': 'box', 'selling_unit': 'unit', 'conversion_factor': 5.0, 'purchase_price': 6200.0, 'selling_price': 1699.0, 'minimum_stock': 2.0, 'recommended_stock': 15.0, 'reorder_quantity': 5.0, 'current_stock': 8.0},
                    {'id': 'pdddddd-0000-0000-0000-000000000009', 'name': 'Braided 1.5m Type-C Fast Cable (యూఎస్బీ కేబుల్)', 'local_name': 'Type-C Cable', 'category': 'Powerbanks & Cables', 'base_unit': 'piece', 'purchase_unit': 'bundle', 'selling_unit': 'piece', 'conversion_factor': 20.0, 'purchase_price': 2200.0, 'selling_price': 199.0, 'minimum_stock': 15.0, 'recommended_stock': 100.0, 'reorder_quantity': 30.0, 'current_stock': 65.0},
                    {'id': 'pdddddd-0000-0000-0000-000000000010', 'name': '9D Edge-to-Edge Tempered Glass (స్క్రీన్ గార్డ్)', 'local_name': 'Screen Guard', 'category': 'Screen Guards & Covers', 'base_unit': 'piece', 'purchase_unit': 'box', 'selling_unit': 'piece', 'conversion_factor': 25.0, 'purchase_price': 1250.0, 'selling_price': 150.0, 'minimum_stock': 20.0, 'recommended_stock': 150.0, 'reorder_quantity': 50.0, 'current_stock': 90.0},
                    {'id': 'pdddddd-0000-0000-0000-000000000011', 'name': 'SanDisk 64GB Ultra MicroSD Card (మెమరీ కార్డు)', 'local_name': 'Memory Card', 'category': 'Storage & Memory', 'base_unit': 'piece', 'purchase_unit': 'pack', 'selling_unit': 'piece', 'conversion_factor': 10.0, 'purchase_price': 3600.0, 'selling_price': 499.0, 'minimum_stock': 5.0, 'recommended_stock': 30.0, 'reorder_quantity': 10.0, 'current_stock': 18.0},
                    {'id': 'pdddddd-0000-0000-0000-000000000012', 'name': 'Noise ColorFit Pulse Smart Watch (స్మార్ట్ వాచ్)', 'local_name': 'Smart Watch', 'category': 'Smartwatches & Gadgets', 'base_unit': 'piece', 'purchase_unit': 'box', 'selling_unit': 'piece', 'conversion_factor': 5.0, 'purchase_price': 6500.0, 'selling_price': 1799.0, 'minimum_stock': 3.0, 'recommended_stock': 15.0, 'reorder_quantity': 5.0, 'current_stock': 8.0},
                ]
            }
        ]
